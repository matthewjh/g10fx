...
/***/ function(module, exports, __webpack_require__) {
	...
	var FxMatrixApi = (function () {
	    ...
	    FxMatrixApi.prototype.getFxMatrix = function (currencies) {
	        var _this = this;
	        var fxResponsePromises = currencies.map(function (c) { return _this._getResponseForBaseCurrency(c); });
	...
	exports.FxMatrixApi = FxMatrixApi;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var FxMatrix = (function (_super) {
	    __extends(FxMatrix, _super);
	    function FxMatrix() {
	        _super.apply(this, arguments);
	    }
	    FxMatrix.prototype.render = function () {
	        var _this = this;
	        var currencyCodes = Object.keys(this.props.fxMatrix);
	        var headingCells = currencyCodes.map(function (c) { return React.createElement("th", null, c); });
